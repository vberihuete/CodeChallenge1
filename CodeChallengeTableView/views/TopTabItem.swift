...
/// This class represents a TopTabItem normally to be used inside a stackview
...
class TopTabItem: UIStackView {
    ...
    init(identifier number: Int, label text: String, color: UIColor = UIColor.black){
    ...
    func markSelected(in animationT: TimeInterval = 0.2, with color: UIColor = UIColor.red, from animationOrigin: TabItemAnimationSide = .left){
        self.bottomView.backgroundColor = color
        self.title.textColor = color
    ...
    ///   - animationOrigin: The origin of the animation .left or .right
    func markUnselected(in animationT: TimeInterval = 0.2, with color: UIColor = UIColor.black, from animationOrigin: TabItemAnimationSide = .right){
        //        self.bottomView.backgroundColor = color
        self.title.textColor = color
        self.selected = false
